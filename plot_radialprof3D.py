...
for varname in varnames:
    ...
    plt.savefig(fout + '{:s}radialxsectiondist_day{:3.0f}to{:3.0f}_{:d}day.pdf'.format(varname, t3D[0], t3D[-1], nave))
    ...
    plt.savefig(fout + '{:s}radialzavedist_day{:3.0f}to{:3.0f}_{:d}day.pdf'.format(varname, t3D[0], t3D[-1], nave))
    #plt.close()
