...
#cdef float[:,:,:] IWP = varis2D['IWP'][:]
#cdef float[:,:,:] LHF = varis2D['LHF'][:]
#cdef float[:,:,:] SHF = varis2D['SHF'][:]
#cdef float[:,:,:] SWVP = varis2D['SWVP'][:]
#cdef float[:,:,:] SWNT = varis2D['SWNT'][:]
#cdef float[:,:,:] SWNS = varis2D['SWNS'][:]
#cdef float[:,:,:] LWNT = varis2D['LWNT'][:]
#cdef float[:,:,:] LWNS = varis2D['LWNS'][:]
...
#cdef float[:,:,:] SWNTC = varis2D['SWNTC'][:]
#cdef float[:,:,:] SWNSC = varis2D['SWNSC'][:]
#cdef float[:,:,:] LWNTC = varis2D['LWNTC'][:]
#cdef float[:,:,:] LWNSC = varis2D['LWNSC'][:]
SWNTC = varis2D['SWNTC'][:]
SWNSC = varis2D['SWNSC'][:]
LWNTC = varis2D['LWNTC'][:]
LWNSC = varis2D['LWNSC'][:]
...
#cdef float[:,:,:,:] qv = varis3D['QV'][:]
#qv = qv*1e-3
#cdef float[:,:,:,:] T = varis3D['TABS'][:]
#cdef float[:,:,:,:] w = varis3D['W'][:]
