...
#sort CRH and w
CRH_wsort = blocksort2D_1Din(CRH_tave[t,:], w_tave[t,:,:], db)
CRHsort = CRH_wsort[0]
wsort = CRH_wsort[1]
...
CRH_varsort = blocksort2D_1Din(CRH_tave[t,:], var_tave[t,:,:], db)
...
plt.title('streamfunction at day {:2.1f}, domain size {:5.0f} km'.format(times[t], domsize))
cb = plt.colorbar()
